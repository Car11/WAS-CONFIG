...
/**
 * <p>Clase cr.go.ice.interrupciones.domain.procedure.PevemqTrisecPropio.java</p>
 * <p>Modulo (subsistema): Interrupciones Web</p>
 * <p>Descricion de <code>PevemqTrisecPropio.java</code>.</p>
 * <p>Fecha creación: 21/09/2007</p>
 * <p>Ultima actualización: 21/09/2007</p>
 * @author Vista Verde Tecnologia (nano)
 * @version 1.1
 */
public class PevemqTrisecPropio extends StoredProcedure {
    private static final String NOMBRE_PROCEDIMIENTO = "PEVEMQ_TRISECPROPIO";
    
    /**
     * Constructor  
     */
    public PevemqTrisecPropio(DataSource ds){
