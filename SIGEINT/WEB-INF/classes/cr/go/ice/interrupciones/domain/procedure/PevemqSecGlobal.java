...
/**
 * <p>Clase cr.go.ice.interrupciones.domain.procedure.PevemqSecGlobal.java</p>
 * <p>Modulo (subsistema): Interrupciones Web</p>
 * <p>Descricion de <code>PevemqSecGlobal.java</code>.</p>
 * <p>Fecha creación: 21/09/2007</p>
 * <p>Ultima actualización: 21/09/2007</p>
 * @author Vista Verde Tecnologia (David)
 * @version 1.1
 */
public class PevemqSecGlobal extends StoredProcedure {
    private static final String NOMBRE_PROCEDIMIENTO = "PEVEMQ_SECGLOBAL";
    
    /**
     * Constructor  
     */
    public PevemqSecGlobal(DataSource ds){
