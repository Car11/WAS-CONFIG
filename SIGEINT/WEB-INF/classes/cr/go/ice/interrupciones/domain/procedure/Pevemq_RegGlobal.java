...
/**
 * <p>Clase cr.go.ice.interrupciones.domain.procedure.Pevemq_RegGlobal.java</p>
 * <p>Modulo (subsistema): Interrupciones Web</p>
 * <p>Descricion de <code>Pevemq_RegGlobal.java</code>.</p>
 * <p>Fecha creación: 21/09/2007</p>
 * <p>Ultima actualización: 21/09/2007</p>
 * @author Vista Verde Tecnologia (David)
 * @version 1.1
 */
public class Pevemq_RegGlobal extends StoredProcedure {

    private static final String NOMBRE_PROCEDIMIENTO = "PEVEMQ_REGGLOBAL";
    
    /**
     * Constructor  
     */
    public Pevemq_RegGlobal(DataSource ds){
