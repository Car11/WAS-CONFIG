...
/**
 * <p>Clase cr.go.ice.interrupciones.domain.procedure.PevemqSubGlobal.java</p>
 * <p>Modulo (subsistema): Interrupciones Web</p>
 * <p>Descricion de <code>PevemqSubGlobal.java</code>.</p>
 * <p>Fecha creación: 21/09/2007</p>
 * <p>Ultima actualización: 21/09/2007</p>
 * @author Vista Verde Tecnologia (nano)
 * @version 1.1
 */
public class PevemqSubGlobal extends StoredProcedure {
    private static final String NOMBRE_PROCEDIMIENTO = "PEVEMQ_SUBGLOBAL";
    
    /**
     * Constructor  
     */
    public PevemqSubGlobal(DataSource ds){
