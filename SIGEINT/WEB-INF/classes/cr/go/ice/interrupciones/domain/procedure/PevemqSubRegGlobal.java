...
/**
 * <p>Clase cr.go.ice.interrupciones.domain.procedure.PevemqSubRegGlobal.java</p>
 * <p>Modulo (subsistema): Interrupciones Web</p>
 * <p>Descricion de <code>PevemqSubRegGlobal.java</code>.</p>
 * <p>Fecha creación: 21/09/2007</p>
 * <p>Ultima actualización: 21/09/2007</p>
 * @author Vista Verde Tecnologia (nano)
 * @version 1.1
 */
public class PevemqSubRegGlobal extends StoredProcedure {
    private static final String NOMBRE_PROCEDIMIENTO = "PEVEMQ_SUBREGGLOBAL";
    
    /**
     * Constructor  
     */
    public PevemqSubRegGlobal(DataSource ds){
