...
public class Pevemq_IndCalidadNac extends BussinessObject {
	
	public Pevemq_IndCalidadNac()
	{
		super();
	}
    @SuppressWarnings("rawtypes")
    public boolean IndicesCalidadNacional(HashMap parametrosProcedimiento)
    {
    	boolean exito = true;
        ...
        try {
            ...
            func = conn.prepareCall("{call PEVEMQ_INDCALIDADNACIONAL (?,?,?)}");
