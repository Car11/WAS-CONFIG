...
/**
 * <p>Clase cr.go.ice.interrupciones.domain.procedure.Pevemq_CirGlobal.java</p>
 * <p>Modulo (subsistema): Interrupciones Web</p>
 * <p>Descricion de <code>Pevemq_CirGlobal.java</code>.</p>
 * <p>Fecha creación: 21/09/2007</p>
 * <p>Ultima actualización: 21/09/2007</p>
 * @author Vista Verde Tecnologia (David)
 * @version 1.1
 */
public class Pevemq_CirGlobal  extends StoredProcedure {

    private static final String NOMBRE_PROCEDIMIENTO = "PEVEMQ_CIRGLOBAL";
    
    /**
     * Constructor  
     */
    public Pevemq_CirGlobal(DataSource ds){
