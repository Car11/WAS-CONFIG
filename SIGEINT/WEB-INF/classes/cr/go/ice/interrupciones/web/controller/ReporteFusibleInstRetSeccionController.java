...
/**
 * <p>Clase cr.go.ice.interrupciones.web.controller.ReporteFusibleInstRetSeccionController.java</p>
 * <p>Modulo (subsistema): Interrupciones Web</p>
 * <p>Descricion de <code>ReporteFusibleInstRetSeccionController.java</code>.</p>
 * <p>Fecha creación: 04/09/2008</p>
 * <p>Ultima actualización: 04/09/2008</p>
 * @author Vista Verde Tecnologia (David)
 * @version 1.1
 */
public class ReporteFusibleInstRetSeccionController extends AbstractFacesController{
     ...
     */    
    public ReporteFusibleInstRetSeccionController(){
        reiniciarCampos();
...
//          boolean userClor = Usuario.isUserClor();
    ...
    private boolean validarOpcionesParametros(){
        ...
        if(this.fechaInicio.compareTo(new Date()) > 0){
           FacesContext.getCurrentInstance().addMessage(null, new FacesMessage(FacesMessage.SEVERITY_ERROR, "Error!", "La fecha de inicio no pueder ser mayor a la fecha actual."));
            correcto=false;
        }  
    ...
    /**
     * Realiza las validaciones de los parámetros de entrada dados por el usuario y genera el reporte de fusibles
...
//            } 
            ...
            parametrosReporte.put("subestacion",sec.getSeccionID().getSubEstacion());
            parametrosReporte.put("circuito",sec.getSeccionID().getCircuito());                                
            ...
            if(this.formato.equals(Integer.valueOf(1))){
                nombre = "FusiblesInstRetSeccion"+ fechaActualSTR +".pdf";
            }else{
                nombre = "FusiblesInstRetSeccion"+ fechaActualSTR +".xls";
            }   
            
           
                nombreArchivo = "SigeItrRepFusiblesInstaladosRetiradosSeccion.jasper";
    ...
    private void pasarParametrosReporte(){        
        ...
        ctx.getExternalContext().getSessionMap().put("tipoReporte",new Integer(ServletReporte.reporteFusiblesInstRetSeccion));
        ...
        ctx.getExternalContext().getSessionMap().put("subestacion",sec.getSeccionID().getSubEstacion());
        ctx.getExternalContext().getSessionMap().put("circuito",sec.getSeccionID().getCircuito());
