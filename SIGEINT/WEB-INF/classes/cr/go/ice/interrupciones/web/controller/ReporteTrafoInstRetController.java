...
/**
 * <p>Clase cr.go.ice.interrupciones.web.controller.ReporteTrafoInstRetController.java</p>
 * <p>Modulo (subsistema): Interrupciones Web</p>
 * <p>Descricion de <code>ReporteTrafoInstRetController.java</code>.</p>
 * <p>Fecha creación: 15/07/2009</p>
 * <p>Ultima actualización: 15/07/2009</p>
 * @author Vista Verde Tecnologia (David)
 * @version 1.1
 */
public class ReporteTrafoInstRetController extends AbstractFacesController{

    private Date fechaInicio;
    private Date fechaFinal;
    private Integer tipoTrafo;
    ...
    /**
     * <code>TRAFO_INSTALADO</code> Trafo instalado
     */    
    public static final Integer TRAFO_INSTALADO = new Integer(0);
    /**
     * <code>TRAFO_RETIRADO</code> Trafo retirado
     */    
    public static final Integer TRAFO_RETIRADO = new Integer(1);
    
    
    /**
     * Constructor por defecto
     */    
    public ReporteTrafoInstRetController(){
        reiniciarCampos();        
    }
    ...
    private void reiniciarCampos(){
        ...
        this.tipoTrafo = TRAFO_INSTALADO;
    ...
    /**
     * Retorna una lista de select item de los tipos de trafos
     * @return Lista de tipos de trafos
     */    
    public List getListaTiposTrafo(){ 
        List tipos = new ArrayList();    
        tipos.add(new SelectItem(TRAFO_INSTALADO, "Instalado"));
        tipos.add(new SelectItem(TRAFO_RETIRADO, "Retirado"));          
        return tipos;       
    }      
    ...
    private boolean validarOpcionesParametros(){
        ...
        if(this.nivelRed.equals("circuito")){
            ...
            if(this.subregion.intValue() <= 0){
            	FacesContext.getCurrentInstance().addMessage(null, new FacesMessage(FacesMessage.SEVERITY_ERROR, "Error!", "Debe seleccionar la subregió.n"));            
                correcto=false;
            }              
    ...
    /**
     * Realiza las validaciones de los parámetros de entrada dados por el usuario y genera el reporte de trafos instalados
     * y retirados
    ...
    private void pasarParametrosReporte(){
        ...
        ctx.getExternalContext().getSessionMap().put("tipoReporte",new Integer(ServletReporte.reporteTrafosInstRet));
        ...
        ctx.getExternalContext().getSessionMap().put("tipoTrafo",this.tipoTrafo);
...
//            } 
            ...
            if(this.nivelRed.equals("region")){
                if(tipoTrafo.equals(ReporteTrafoInstRetController.TRAFO_INSTALADO))
                    nombreArchivo = "SigeItrRepTrafosInstaladosRegion";
                else
                    nombreArchivo = "SigeItrRepTrafosRetiradosRegion";
            }
            if(this.nivelRed.equals("subregion")){
                if(tipoTrafo.equals(ReporteTrafoInstRetController.TRAFO_INSTALADO))
                    nombreArchivo = "SigeItrRepTrafosInstaladosSubregion";
                else
                    nombreArchivo = "SigeItrRepTrafosRetiradosSubregion";
            }   
            if(this.nivelRed.equals("subestacion")){
                if(tipoTrafo.equals(ReporteTrafoInstRetController.TRAFO_INSTALADO))
                    nombreArchivo = "SigeItrRepTrafosInstaladosSubestacion";
                else
                    nombreArchivo = "SigeItrRepTrafosRetiradosSubestacion";
            }                 
            if(this.nivelRed.equals("circuito")){
                if(tipoTrafo.equals(ReporteTrafoInstRetController.TRAFO_INSTALADO))
                    nombreArchivo = "SigeItrRepTrafosInstaladosCircuito";
                else
                    nombreArchivo = "SigeItrRepTrafosRetiradosCircuito";
            }   
            nombre = "InterrupTransfInstRet";
    ...
    /**
     * Metodo accesor de tipoTrafo.
     * @return Retorna el tipoTrafo.
     */
    public Integer getTipoTrafo() {
        return this.tipoTrafo;
    }

    /**
     * Metodo modificador de tipoTrafo.
     * @param tipoTrafo El tipoTrafo a modificar.
     */
    public void setTipoTrafo(Integer tipoTrafo) {
