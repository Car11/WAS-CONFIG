...
/**
 * <p>Clase cr.go.ice.interrupciones.web.controller.ReporteInterrupcionIndicadorTrifasicoController.java</p>
 * <p>Modulo (subsistema): Interrupciones Web</p>
 * <p>Descricion de <code>ReporteInterrupcionIndicadorTrifasicoController.java</code>.</p>
 * <p>Fecha creación: 11/06/2008</p>
 * <p>Ultima actualización: 11/06/2008</p>
 * @author Vista Verde Tecnologia (David)
 * @version 1.1
 */
public class ReporteInterrupcionIndicadorTrifasicoController extends AbstractFacesController{
     ...
     */    
    public ReporteInterrupcionIndicadorTrifasicoController(){
        reiniciarCampos();
...
//            } 
            ...
            if(nivelRed.equals("circuito")){
                ...
                if(utilizarDatosHistoricos)
                    nombreArchivo = "SigeItrRepInterrupcionIndicadorTrifasicoCircuitoHistorico";
                else                          
                    nombreArchivo = "SigeItrRepInterrupcionIndicadorTrifasicoCircuito";
            ...
            if(nivelRed.equals("seccion")){
                ...
                parametrosReporte.put("restriccionSQL",restriccionSQL);
                if(utilizarDatosHistoricos)
                    nombreArchivo = "SigeItrRepInterrupcionIndicadorTrifasicoSeccionHistorico";
                else                         
                    nombreArchivo = "SigeItrRepInterrupcionIndicadorTrifasicoSeccion";
    ...
    private void pasarParametrosReporte(){
        ...
        ctx.getExternalContext().getSessionMap().put("tipoReporte",new Integer(ServletReporte.reporteIndicadorTrifasico));
