...
/**
 * <p>Clase cr.go.ctp.rrhh.utils.FacesUtils.java</p>
 * <p>Modulo (subsistema): RRHHWeb</p>
 * <p> Descricion de <code>FacesUtils.java</code>.</p>
 * <p>Fecha creación: 11/12/2007</p>
 * <p>Ultima actualización: 14/05/2008</p>
 * @author Vista Verde Tecnologia (Diego Hernández)
 * @version 1.1s
 */
...
public class FacesUtils {
	...
	//SessionBean objAppIncapacidades;
	...
	/**
	 * @return Devuelve objAppIncapacidades.
	 */
	/*public static SessionBean getObjAppIncapacidades() {
		return (SessionBean)getFacesContext().getApplication()
		.createValueBinding("#{sessionBean}").getValue(getFacesContext());
	}*/
	
	/**
	 *  Comentario para getLabelMenu
	 * @param lst
	 * @param value
	 * @return String
	 */

	public static String getLabelMenu(List lst, Integer value) {
		
		String label = "";
		for (int i=0; i<lst.size(); i++) {
			
			SelectItem si = (SelectItem)lst.get(i);
			Integer siValue = (Integer)si.getValue();
			
			if (siValue.equals(value)) {
